...
export default class Main extends React.Component {
    ...
    window.onmessage = (e) => {
      if (e.ports[0]) {
        ...
        messagePort.onmessage = function (event) {
          console.log('[MessagePorts][tab1][port1 get message from port2]:', event.data)
        }

        this.messagePort = messagePort

        console.log('[MessagePorts][tab1]init ok,have MessageChannel port1')
      }
    }
  ...
  */
  ...
  setSharedState = () => {
    ...
    window.api.setSharedState(this.state)
  }
  ...
  testOpenView = () => {
    console.log('testOpenView')
    window.api.testOpenView()
  }

  testOpenWindow = () => {
    console.log('testOpenWindow')
    window.api.testOpenWindow()
  }
  ...
  render () {
    ...
    return (
      <Container fluid style={{ backgroundColor: '#28eff5' }}>
        ...
        <Row style={rowStyle}><Col>tab1</Col></Row>
        <Row style={rowStyle}><Col>開啟視窗測試</Col></Row>
        <Row style={rowStyle}>
          <Col><Button variant='primary' onClick={this.testOpenView}>顯示WebContentsView</Button></Col>
          <Col><Button variant='primary' onClick={this.testOpenWindow}>顯示BrowserWindow</Button></Col>
        </Row>
        ...
        <Row style={rowStyle}>
          <Col>
            username:<input name='username'
              ...
              onChange={this.myInputChangeHandler}
            /><br/>
            description:<input name='description'
              ...
              onChange={this.myInputChangeHandler}
            /><br/>
            <Button variant='primary' onClick={this.setSharedState}>寫入公用狀態</Button>
          </Col>
        </Row>
